...
This log filter implementation is based on the logging.Filter class.

For structlog-based implementation check the [structlog](https://github.com/suprotkin/custom_logging_filters/tree/structlog) branch. 
